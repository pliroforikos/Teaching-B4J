...
__ref.getField(false,"_page1" /*RemoteObject*/ ).runClassMethod (b4j.example.b4xpage1.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 22;BA.debugLine="B4XPages.AddPage(\"my first Page\", page1)";
Debug.ShouldStop(2097152);
b4xmainpage._b4xpages.runVoidMethod ("_addpage" /*RemoteObject*/ ,(Object)(BA.ObjectToString("my first Page")),(Object)((__ref.getField(false,"_page1" /*RemoteObject*/ ))));
...
Debug.ShouldStop(16777216);
 BA.debugLineNum = 27;BA.debugLine="B4XPages.ShowPage(\"my first Page\")";
Debug.ShouldStop(67108864);
b4xmainpage._b4xpages.runVoidMethod ("_showpage" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("my first Page")));
...
b4xmainpage._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");__ref.setField("_xui",b4xmainpage._xui);
 //BA.debugLineNum = 11;BA.debugLine="Private page1 As B4XPage1";
