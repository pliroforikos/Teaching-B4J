...
b4xpageprimary.myClass = BA.getDeviceClass ("b4j.example.b4xpageprimary");
b4xpagesecondary.myClass = BA.getDeviceClass ("b4j.example.b4xpagesecondary");
b4xpagetriangle.myClass = BA.getDeviceClass ("b4j.example.b4xpagetriangle");
