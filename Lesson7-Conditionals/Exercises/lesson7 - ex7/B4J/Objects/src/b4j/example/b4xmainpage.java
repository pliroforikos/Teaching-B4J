...
RDebugUtils.currentLine=7798785;
 //BA.debugLineNum = 7798785;BA.debugLine="Private fltTotal As Float";
_flttotal = 0f;
RDebugUtils.currentLine=7798787;
 //BA.debugLineNum = 7798787;BA.debugLine="If txtQuantity.text < 200 Then";
if ((double)(Double.parseDouble(__ref._txtquantity /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))<200) { 
RDebugUtils.currentLine=7798788;
 //BA.debugLineNum = 7798788;BA.debugLine="fltTotal = txtQuantity.text * 0.70";
_flttotal = (float) ((double)(Double.parseDouble(__ref._txtquantity /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))*0.70);
RDebugUtils.currentLine=7798789;
 //BA.debugLineNum = 7798789;BA.debugLine="lblMessage.Text = \"Total Cost = \" & fltTotal";
__ref._lblmessage /*anywheresoftware.b4j.objects.LabelWrapper*/ .setText("Total Cost = "+BA.NumberToString(_flttotal));
 }else {
RDebugUtils.currentLine=7798791;
 //BA.debugLineNum = 7798791;BA.debugLine="fltTotal = txtQuantity.text * 0.50";
_flttotal = (float) ((double)(Double.parseDouble(__ref._txtquantity /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))*0.50);
RDebugUtils.currentLine=7798792;
 //BA.debugLineNum = 7798792;BA.debugLine="lblMessage.Text = \"Total Cost = \" & fltTotal";
__ref._lblmessage /*anywheresoftware.b4j.objects.LabelWrapper*/ .setText("Total Cost = "+BA.NumberToString(_flttotal));
 };
...
RDebugUtils.currentLine=458757;
 //BA.debugLineNum = 458757;BA.debugLine="Private txtQuantity As TextField";
