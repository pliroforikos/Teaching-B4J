...
phone.myClass = BA.getDeviceClass ("b4j.example.phone");
b4xpagesphones.myClass = BA.getDeviceClass ("b4j.example.b4xpagesphones");
b4xpageshowphone.myClass = BA.getDeviceClass ("b4j.example.b4xpageshowphone");
b4xpagesell.myClass = BA.getDeviceClass ("b4j.example.b4xpagesell");
b4xpagewarehouse.myClass = BA.getDeviceClass ("b4j.example.b4xpagewarehouse");
b4xpagerevenue.myClass = BA.getDeviceClass ("b4j.example.b4xpagerevenue");
